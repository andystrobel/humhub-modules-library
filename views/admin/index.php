...
<div class="panel panel-default">
    <div class="panel-heading"><?php echo Yii::t('LibraryModule.admin', 'Library configuration'); ?></div>
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="checkbox">
                <label>
                    <?php echo $form->checkBox($model, 'globalPublicLibrary'); ?> <?php echo Yii::t('LibraryModule.admin', 'Enable global public library.'); ?>
                </label>
            </div>
            <p class="help-block"><?php echo Yii::t('LibraryModule.admin', 'A public library will be added to the top menu. It contains all public library categories from all spaces.'); ?></p>
        ...
        <div class="form-group">
            ...
            <div class="checkbox">
                <label>
                    <?php echo $form->checkBox($model, 'disclaimerWidget'); ?> <?php echo Yii::t('LibraryModule.admin', 'Show disclaimer widget in global public library.'); ?>
                </label>
            </div>
            ...
            <p class="help-block"><?php echo Yii::t('LibraryModule.admin', 'A disclaimer will be added to the public library.'); ?></p>
            <?php echo $form->error($model, 'globalPublicLibrary'); ?>
        </div>
