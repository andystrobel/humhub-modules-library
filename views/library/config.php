...
<div class="panel panel-default">
    <div class="panel-heading"><?php echo Yii::t('LibraryModule.admin', 'Library Module Configuration'); ?></div>
    <div class="panel-body">

        <p><?php echo Yii::t('LibraryModule.admin', 'You can configure extended functionality of this module for a space or user.'); ?></p><br />
